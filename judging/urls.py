...
urlpatterns = [
    ...
    path('projects/directory/', views.JudgeProjectDirectoryView.as_view(), name='project_directory'),
    ...
    path('manage/winners/', views.TrackWinnersView.as_view(), name='track_winners'),
